...
def test_find_alert_command(mocker):
    """
    Given:
    ...
    result_alert = util_load_json('./test_data/find_alert_result.json')
    mocker.patch.object(Client, 'find_alert_request', return_value=result_alert)
    results = find_alert_command(client, args={'id_': '1'})
...
def test_update_case_command(mocker):
    ...
    """
    client = Client(server_url=URL, verify=False, proxy=False, headers={}, auth={})
    mocker.patch.object(Client, 'update_case_request', return_value='')
    results = update_case_command(client, args={'id_': '1234', 'status': 'IN_PROGRESS'})
...
def test_acknowledge_case_command(mocker):
    ...
    """
    client = Client(server_url=URL, verify=False, proxy=False, headers={}, auth={})
    mocker.patch.object(Client, 'acknowledge_case_request', return_value='')
    results = acknowledge_case_command(client, args={'id_': '1234'})
...
def test_resolve_case_command(mocker):
    ...
    """
    client = Client(server_url=URL, verify=False, proxy=False, headers={}, auth={})
    mocker.patch.object(Client, 'resolve_case_request', return_value='')
    results = resolve_case_command(client, args={'id_': '1234', 'caseresolution_resolutionnotes': 'test'})
...
def test_find_playbook(mocker):
    client = Client(server_url=URL, verify=False, proxy=False, headers={}, auth={})
    result_playbook = util_load_json('./test_data/find_playbook_result.json')
    mocker.patch.object(Client, 'find_playbook_request', return_value=result_playbook)
...
def test_create_case(mocker):
    ...
    mocker.patch.object(Client, 'create_case_request', return_value=result_case)
    arg_json = {
...
def test_find_task(mocker):
    ...
    mocker.patch.object(Client, 'find_task_request', return_value=result_task)
    results = find_task_command(client, args={'id_': '12'})
...
def test_confirm_incident_command(mocker):
    ...
    """
    client = Client(server_url=URL, verify=False, proxy=False, headers={}, auth={})
    mocker.patch.object(Client, 'confirm_case_incident_request', return_value='')
    results = confirm_case_incident_command(client, args={'id_': '1234'})
